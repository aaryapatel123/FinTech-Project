...
if __name__ == "__main__":
    ...
    print(f"\n✅ Found {len(all_transactions)} non-derivative transactions for NVIDIA between {start_date} and {end_date}")

    # ✅ Export results to CSV
    if all_transactions:
        csv_filename = f"nvidia_form4_{start_date}_to_{end_date}.csv"
